...
const Team = () => {
  ...
  return (
    <Layout>
      <div className="w-full flex flex-col bg-[#fefefe] lg:px-32 px-10 md:py-5 lg:py-8 pt-10 py-1 lg:mt-5 mb-10 md:h-[2200px] h-[3000px]">
            ...
            {daftarTeamMember.map((data) => (
              <div className="flex flex-col gap-2" key={data.id}>
                ...
                <p className="flex gap-1 items-center">
                  ...
                  <a
                    href={data.instagram}
                    className="text-blue-500 hover:text-[#006837]"
                  >
                    @{data.username}
                  </a>
                </p>
