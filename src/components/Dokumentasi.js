...
export default function Dokumentasi() {
  ...
  return (
    <section className="w-full h-[500px] md:h-[800px] flex flex-col md:justify-start md:items-start justify-center items-center bg-[#fefefe] lg:px-44 xl:px-32 md:px-10 md:py-5 lg:py-8 pt-0 md:pt-10 py-1 flex-wrap md:mt-10 mb-10 md:mb-0 -mt-10">
