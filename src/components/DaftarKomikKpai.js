...
const DaftarKomikKPAI = () => {
  ...
  return (
    <div className="w-full h-[700px] flex flex-col md:justify-start md:items-start justify-center items-center bg-[#fefefe] lg:px-44 xl:px-32 md:px-10 md:py-5 lg:py-8 pt-10 py-1 flex-wrap mt-10 mb-10 md:mb-0">
      ...
      <div className="flex flex-row h-[500px] mx-1 md:mx-0 gap-3 justify-center md:justify-start md:-mt-0 gap-y-5 md:gap-y-20 mb-16 w-full">
